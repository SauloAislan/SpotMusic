package br.com.sauloaislan.controller;


/**
 * @author SauloAislan
 * created on 30/09/2019
 * inside the package - br.com.sauloaislan.controller
 **/

import br.com.sauloaislan.domain.Playlist;
import br.com.sauloaislan.service.PlaylistService;
...
public class PlaylistController {
    ...
    public String salvar(@Valid @ModelAttribute("playlist") Playlist playlist,
        ...
        attr.addFlashAttribute("mensagem", "Playlist criado com sucesso.");
    ...
    @PutMapping("/salvar")
    public String atualizar(@Valid @ModelAttribute("playlist") Playlist playlist,
                            BindingResult result, RedirectAttributes attr){
        if(result.hasErrors()){
            return "/playlist/add";
        }
